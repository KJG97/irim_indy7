...
class INDY7ReachIKRelMimicEnv(ManagerBasedRLMimicEnv):
    """
    Isaac Lab Mimic environment wrapper class for Indy7 Reach IK Rel env.
    """
    ...
    def get_subtask_term_signals(self, env_ids: Sequence[int] | None = None) -> dict[str, torch.Tensor]:
        ...
        signals["reached"] = subtask_terms["reached"][env_ids]
        return signals