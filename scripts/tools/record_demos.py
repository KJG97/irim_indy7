...
from isaaclab.devices import Se3HandTracking, Se3Keyboard, Se3SpaceMouse, Se3ViveTracker
...
def main():
    ...
    if args_cli.teleop_device.lower() == "keyboard":
        ...
        teleop_interface = Se3ViveTracker(
                pos_scale= 4.0, rot_scale= 3.0, 
                device_key="tracker"
            )
        teleop_interface.add_callback("R", reset_recording_instance)
    else:
        raise ValueError(
            f"Invalid device interface '{args_cli.teleop_device}'. Supported: 'vivetracker','keyboard', 'spacemouse', 'handtracking'."
        )
