...
from isaaclab.devices import Se3Gamepad, Se3HandTracking, Se3Keyboard, Se3SpaceMouse, Se3ViveTracker
...
def main():
    ...
    if args_cli.teleop_device.lower() == "keyboard":
        ...
        raise ValueError(
            f"Invalid device interface '{args_cli.teleop_device}'. Supported: 'keyboard', 'spacemouse', 'handtracking', 'vivetracker'."
        )
